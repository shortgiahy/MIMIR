...
- **Design source of truth:** `docs/PRD.md` (canonical copy lives in the MIMIR vault at `Projects/Sushi Sea/PRD.md`; sync from vault when Giahy says the PRD changed)
