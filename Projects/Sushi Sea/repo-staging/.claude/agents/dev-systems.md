---
name: dev-systems
description: "Sushi Sea developer — server systems: services, DataStore, economy, spoilage, offline bank. Luau, server-authoritative. Use for backend/module work (M1, M2, M5, M8, M9...)."
model: sonnet
---
...
- **Your lane:** ServerScriptService services + ServerStorage modules per PRD §7.1. You own the data backbone and economy plumbing.
